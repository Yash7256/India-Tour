  ...
  public: {
    Tables: {
        ...
        Relationships: [
          {
            ...
            columns: ["state_id"]
            isOneToOne: false
            referencedRelation: "state_statistics"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "fk_cities_state"
      ...
      local_specialties: {
        ...
        Relationships: [
          {
            foreignKeyName: "local_specialties_city_id_fkey"
            columns: ["city_id"]
            isOneToOne: false
            referencedRelation: "cities"
            referencedColumns: ["id"]
      ...
      transport_options: {
        ...
        Relationships: [
          {
            foreignKeyName: "transport_options_city_id_fkey"
            columns: ["city_id"]
            isOneToOne: false
            referencedRelation: "cities"
            referencedColumns: ["id"]
    ...
    Enums: {
      place_category:
        ...
        | "desert"
        | "backwaters"
      price_range: "budget" | "moderate" | "luxury" | "premium"
      specialty_category: "food" | "craft" | "culture"
      transport_type: "bus" | "train" | "taxi" | "metro" | "auto"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
