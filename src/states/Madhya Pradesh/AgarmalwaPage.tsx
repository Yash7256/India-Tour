    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative h-96 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-start text-white p-8">
          ...
          <h1 className="text-6xl font-bold mb-2">Agar Malwa</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="text-2xl font-bold mb-4">About Agar Malwa</h2>
              <p className="text-gray-600 mb-6">
                Agar Malwa is a city and a municipality in the Ujjain division of Madhya Pradesh, India. It is the administrative headquarters of Agar Malwa District.
              </p>
                ...
                {nearbyDestinations.map((destination) => (
                  <div key={destination.id} className="relative rounded-xl overflow-hidden h-48 group cursor-pointer">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-4">
                      ...
                      <p className="text-gray-200">{destination.distance} from Agar Malwa</p>
