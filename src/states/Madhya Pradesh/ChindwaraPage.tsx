...
const ChindwaraPage = () => {
  ...
  const [cityId, setCityId] = useState<string>('chhindwara-mp');
  ...
  return (
    <div className="min-h-screen bg-gray-50">
     ...
     <div className="relative h-96 overflow-hidden">
        <img
          src="https://media-cdn.tripadvisor.com/media/photo-c/1280x250/10/9c/a0/3e/tamia-valley-madhya-pradesh.jpg"
          alt="chhindwara"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="text-2xl font-bold mb-4">About CHHINDWARA</h2>
              <p className="text-gray-600 mb-6">
              
                CHHINDWARA – The Green Heart of Satpura Hills, a city of forts, palaces, and timeless heritage.
              </p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="bg-gray-100 rounded-lg h-48 relative overflow-hidden mb-4">
                <iframe
                  src="https://www.google.com/maps?q=Chhindwara,+Madhya+Pradesh&output=embed"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
