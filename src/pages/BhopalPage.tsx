          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold">INDIA<span className="text-orange-500">TOUR</span></span>
              </div>
            </div>
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-gray-600 hover:text-orange-500 flex items-center">
                <span>🏠</span> <span className="ml-1">Home</span>
              </a>
              <a href="#" className="text-gray-600 hover:text-orange-500 flex items-center">
                <span>📍</span> <span className="ml-1">Destinations</span>
              </a>
              <a href="#" className="text-gray-600 hover:text-orange-500 flex items-center">
                <span>📸</span> <span className="ml-1">Gallery</span>
              </a>
              <a href="#" className="text-gray-600 hover:text-orange-500 flex items-center">
                <span>ℹ️</span> <span className="ml-1">About</span>
              </a>
              <a href="#" className="text-gray-600 hover:text-orange-500 flex items-center">
                <span>📞</span> <span className="ml-1">Contact</span>
              </a>
              ...
              <button className="bg-orange-500 text-white px-4 py-2 rounded-md font-medium">
                Login
              </button>
            </nav>
          </div>
                ...
                {nearbyDestinations.map((destination) => (
                  <div key={destination.id} className="relative rounded-xl overflow-hidden h-48 group cursor-pointer">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-4">
                      ...
                      <p className="text-gray-200">{destination.distance} from Bhopal</p>
