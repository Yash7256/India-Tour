  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative h-96 overflow-hidden">
        <img 
          src="https://i.ibb.co/LzDcdtHz/0-x-Lf-RCl-JS5-DPj9f-Kj.webp" 
          alt="Satna" 
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-start text-white p-8">
          ...
          <h1 className="text-6xl font-bold mb-2">Satna</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-xl shadow-sm p-6">
              <h2 className="text-2xl font-bold mb-4">About Satna</h2>
